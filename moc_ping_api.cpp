/****************************************************************************
** Meta object code from reading C++ file 'ping_api.h'
**
...
#error "The header file 'ping_api.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 10), // "pingResult"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7), // "address"
QT_MOC_LITERAL(4, 31, 9) // "isSuccess"

    },
    "PingWorker\0pingResult\0\0address\0isSuccess"
};
...
void PingWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->pingResult((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PingWorker::*)(const QString & , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PingWorker::pingResult)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PingWorker::pingResult(const QString & _t1, bool _t2)
{
