...
struct qt_meta_stringdata_Logger1_t {
    QByteArrayData data[4];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Logger1_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Logger1_t qt_meta_stringdata_Logger1 = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Logger1"
QT_MOC_LITERAL(1, 8, 8), // "writeLog"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 7) // "message"

    },
    "Logger1\0writeLog\0\0message"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Logger1[] = {
...
void Logger1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Logger1 *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->writeLog((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
...
QT_INIT_METAOBJECT const QMetaObject Logger1::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Logger1.data,
    qt_meta_data_Logger1,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *Logger1::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Logger1::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_Logger1.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int Logger1::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QObject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
